...
void SettingsLoadWrapper::Entry(const char *section, const char *var, std::string &value,
...
void SettingsLoadWrapper::_EnumEntry(const char *section, const char *var, int &value, const char *const *enumArray,
                                     int defvalue)
{
    ...
    if (enumArray[i] == nullptr) {
        Console.Warning(
            "(LoadSettings) Warning: Unrecognized value '%s' on key '%s'\n\tUsing the default setting of '%s'.",
...
bool SettingsLoadWrapper::EntryBitBool(const char *section, const char *var, bool value,
