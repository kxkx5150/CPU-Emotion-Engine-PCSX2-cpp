...
template <uint size> void MemProtectStatic(u8 (&arr)[size], const PageProtectionMode &mode)
{
...
#define SafeSysMunmap(ptr, size) ((void)(HostSys::Munmap((uptr)(ptr), size), (ptr) = 0))
