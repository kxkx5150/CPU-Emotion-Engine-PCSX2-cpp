...
class SettingsWrapper {
  public:
    ...
    virtual void Entry(const char *section, const char *var, std::string &value,
    ...
    template <typename T>
    void EnumEntry(const char *section, const char *var, T &value, const char *const *enumArray = nullptr,
  ...
  protected:
    virtual void _EnumEntry(const char *section, const char *var, int &value, const char *const *enumArray,
                            int defvalue) = 0;
...
class SettingsLoadWrapper final : public SettingsWrapper {
  public:
    ...
    void Entry(const char *section, const char *var, std::string &value,
               const std::string &default_value = std::string()) override;
  ...
  protected:
    void _EnumEntry(const char *section, const char *var, int &value, const char *const *enumArray,
                    int defvalue) override;
};
...
#define SettingsWrapBitfieldEx(varname, textname)                                                                      \
    varname = wrap.EntryBitfield(CURRENT_SETTINGS_SECTION, textname, varname, varname)
#define SettingsWrapBitBoolEx(varname, textname)                                                                       \
    varname = wrap.EntryBitBool(CURRENT_SETTINGS_SECTION, textname, !!varname, varname)
