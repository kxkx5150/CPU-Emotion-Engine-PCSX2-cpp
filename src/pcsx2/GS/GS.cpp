...
std::unique_ptr<GSScanlineConstantData> g_const;
...
#endif
size_t GSApp::GetIniString(const char *lpAppName, const char *lpKeyName, const char *lpDefault, char *lpReturnedString,
...
void GSApp::Init()
{
    ...
    m_gs_bifilter.push_back(
        GSSetting(static_cast<uint32>(BiFiltering::Forced_But_Sprite), "Bilinear", "Forced excluding sprite"));
    ...
    m_gs_crc_level = {
        GSSetting(CRCHackLevel::Automatic, "Automatic", "Default"), GSSetting(CRCHackLevel::NONE, "None", "Debug"),
        GSSetting(CRCHackLevel::Minimum, "Minimum", "Debug"),
#ifdef _DEBUG
        GSSetting(CRCHackLevel::Partial, "Partial", "OpenGL"),      GSSetting(CRCHackLevel::Full, "Full", "Direct3D"),
#endif
    ...
    m_default_configuration["shaderfx_conf"]              = "ini/GS_FX_Settings.ini";
    m_default_configuration["shaderfx_glsl"]              = "ini/GS.fx";
...
{
    wxString iniName(appIniPath + L"/GS.ini");
