...
DHCPopSubnet::DHCPopSubnet(IP_Address mask) : subnetMask{mask}
{
}
...
DHCPopRouter::DHCPopRouter(const std::vector<IP_Address> &routerIPs) : routers{routerIPs}
{
}
...
DHCPopDNS::DHCPopDNS(const std::vector<IP_Address> &dnsIPs) : dnsServers{dnsIPs}
{
}
...
DHCPopBCIP::DHCPopBCIP(IP_Address data) : broadcastIP{data}
{
}
...
DHCPopREQIP::DHCPopREQIP(IP_Address data) : requestedIP{data}
{
}
...
DHCPopIPLT::DHCPopIPLT(u32 LeaseTime) : ipLeaseTime{LeaseTime}
{
}
...
DHCPopMSG::DHCPopMSG(u8 msg) : message{msg}
{
}
...
DHCPopSERVIP::DHCPopSERVIP(IP_Address data) : serverIP{data}
{
}
...
DHCPopREQLIST::DHCPopREQLIST(const std::vector<u8> &requestList) : requests{requestList}
{
}
...
DHCPopMMSGS::DHCPopMMSGS(u16 mms) : maxMessageSize{mms}
{
}
...
DHCPopT1::DHCPopT1(u32 t1) : ipRenewalTimeT1{t1}
{
}
...
DHCPopT2::DHCPopT2(u32 t2) : ipRebindingTimeT2{t2}
{
}
...
DHCPopClientID::DHCPopClientID(const std::vector<u8> &value) : clientID{value}
{
}
