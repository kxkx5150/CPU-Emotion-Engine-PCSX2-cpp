...
void HddCreate::Start()
{
    ...
    progressDialog = new wxProgressDialog(
        wxString("Creating HDD file"), wxString("Creating HDD file"), neededSize, nullptr,
    ...
    if (errored.load()) {
        // wxMessageDialog dialog(nullptr,wxString("Failed to create HDD file"),wxString("Info"), wxOK);
        // dialog.ShowModal();
    }
