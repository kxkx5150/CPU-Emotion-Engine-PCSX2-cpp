...
const char *CmdName[0x100] = {
    ...
    "CdlGetlocL", "CdlGetlocP", "Cdl18",     "CdlGetTN", "CdlGetTD",   "CdlSeekL",     "CdlSeekP",   NULL,
    NULL,         "CdlTest",    "CdlID",     "CdlReadS", "CdlReset",   NULL,           "CDlReadToc", NULL};
...
const uint shortSectorSeekReadDelay =
    1000;                            // delay for reads/seeks that may or may not have a seek action preceeding it
...
//#define CDRCMD_DEBUG
    ...
    switch (cdr.Cmd) {
        ...
        case CdlSetloc: {
            ...
            cdr.SetlocPending = 1;
            AddIrqQueue(cdr.Cmd,
                        0x800);    // the seek delay occurs on the next read / seek command (CdlReadS, CdlSeekL, etc)
        } break;
        do_CdlPlay:
        case CdlPlay:
            // Taken from pcsxr
