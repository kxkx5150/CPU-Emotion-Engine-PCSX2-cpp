...
{
    // SIF0 and SIF1 DMA IRQ's cannot be supressed due to a mask flag for "tag" interrupts being available which cannot
    // be disabled. The hardware can't disinguish between the DMA End and Tag Interrupt flags on these channels so
    // interrupts always fire
