...
void idct(int *block, int k)
{
    ...
    for (i = 0; i < DCTSIZE; i++, ptr++) {
        ...
        if ((ptr[DCTSIZE * 1] | ptr[DCTSIZE * 2] | ptr[DCTSIZE * 3] | ptr[DCTSIZE * 4] | ptr[DCTSIZE * 5] |
             ptr[DCTSIZE * 6] | ptr[DCTSIZE * 7]) == 0) {
            ptr[DCTSIZE * 0] = ptr[DCTSIZE * 1] = ptr[DCTSIZE * 2] = ptr[DCTSIZE * 3] = ptr[DCTSIZE * 4] =
                ptr[DCTSIZE * 5] = ptr[DCTSIZE * 6] = ptr[DCTSIZE * 7] = ptr[DCTSIZE * 0];
...
static int zscan[DCTSIZE2] = {0,  1,  8,  16, 9,  2,  3,  10, 17, 24, 32, 25, 18, 11, 4,  5,  12, 19, 26, 33, 40, 48,
