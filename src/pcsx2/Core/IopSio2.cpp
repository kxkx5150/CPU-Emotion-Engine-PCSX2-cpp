...
//		0xBF808260,										serial data/fifo
// in/out s/get8260_datain/out packet->sendbuf(nomem!)
...
//		0xBF808280										interrupt
// related s/get8280_intr
...
u32 sio2_getRecv3()
{
    if (sio2.packet.recvVal3 == 0x8C || sio2.packet.recvVal3 == 0x8b || sio2.packet.recvVal3 == 0x83) {
...
void sio2_setSend1(u32 index, u32 value)
{
    sio2.packet.sendArray1[index] = value;
}    // 0->3
u32 sio2_getSend1(u32 index)
{
    return sio2.packet.sendArray1[index];
}    // 0->3
void sio2_setSend2(u32 index, u32 value)
{
    sio2.packet.sendArray2[index] = value;
}    // 0->3
u32 sio2_getSend2(u32 index)
{
    return sio2.packet.sendArray2[index];
}    // 0->3
...
u32 sio2_getSend3(u32 index)
{
    return sio2.packet.sendArray3[index];
}    // 0->15
...
void sio2_serialIn(u8 value)
{
    ...
    if (sio2.packet.sendArray3[sio2.cmdport] && (sio2.cmdlength == 0)) {
        ...
        // sioWriteCtrl16(SIO_RESET);
        sioWriteCtrl16(ctrl);
        // PSXDMA_LOG("sio2_fifoIn: ctrl = %x, cmdlength = %x, cmdport = %d (%x)", ctrl, sio2.cmdlength, sio2.cmdport,
        // sio2.packet.sendArray3[sio2.cmdport]);
