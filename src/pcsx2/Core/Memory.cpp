...
// REGULAR MEM START
/////////////////////////////
static vtlbHandler null_handler,

    tlb_fallback_0, tlb_fallback_2, tlb_fallback_3, tlb_fallback_4, tlb_fallback_5, tlb_fallback_6, tlb_fallback_7,
    tlb_fallback_8,

    vu0_micro_mem, vu1_micro_mem, vu1_data_mem,

    hw_by_page[0x10] = {0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,
                        0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF},

    gs_page_0, gs_page_1,

    iopHw_by_page_01, iopHw_by_page_03, iopHw_by_page_08;
...
template <int p> static mem8_t __fastcall _ext_memRead8(u32 mem)
{
    switch (p) {
        case 3:    // psh4
...
template <int p> static mem16_t __fastcall _ext_memRead16(u32 mem)
{
    switch (p) {
        case 4:    // b80
...
template <int p> static mem32_t __fastcall _ext_memRead32(u32 mem)
{
    switch (p) {
        case 6:    // gsm
            return gsRead32(mem);
...
template <int p> static RETURNS_R64 _ext_memRead64(u32 mem)
{
    switch (p) {
        case 6:    // gsm
...
template <int p> static RETURNS_R128 _ext_memRead128(u32 mem)
{
    switch (p) {
        // case 1: // hwm
...
template <int p> static void __fastcall _ext_memWrite8(u32 mem, mem8_t value)
{
    switch (p) {
        case 3:    // psh4
...
template <int p> static void __fastcall _ext_memWrite16(u32 mem, mem16_t value)
{
    switch (p) {
        case 5:    // ba0
...
template <int p> static void __fastcall _ext_memWrite32(u32 mem, mem32_t value)
{
    switch (p) {
        case 6:    // gsm
            gsWrite32(mem, value);
...
template <int p> static void __fastcall _ext_memWrite64(u32 mem, const mem64_t *value)
{
...
template <int p> static void __fastcall _ext_memWrite128(u32 mem, const mem128_t *value)
{
    /*switch (p) {
            //case 1: // hwm
    ...
    // MEM_LOG("Unknown Memory write128 to  address %x with data %8.8x_%8.8x_%8.8x_%8.8x", mem, ((u32*)value)[3],
    // ((u32*)value)[2], ((u32*)value)[1], ((u32*)value)[0]);
    cpuTlbMissW(mem, cpuRegs.branch);
}

#define vtlb_RegisterHandlerTempl1(nam, t)                                                                             \
    vtlb_RegisterHandler(nam##Read8<t>, nam##Read16<t>, nam##Read32<t>, nam##Read64<t>, nam##Read128<t>,               \
...
void memBindConditionalHandlers()
{
    ...
    if (EmuConfig.Speedhacks.IntcStat) {
        ...
        vtlb_ReassignHandler(hw_by_page[0xf], hwRead8<0x0f>, page0F16, page0F32, hwRead64<0x0f>, hwRead128<0x0f>,
...
// --------------------------------------------------------------------------------------
eeMemoryReserve::eeMemoryReserve() : _parent(L"EE Main Memory", sizeof(*eeMem))
{
}
...
void eeMemoryReserve::Reset()
{
    ...
    null_handler = vtlb_RegisterHandler(nullRead8, nullRead16, nullRead32, nullRead64, nullRead128, nullWrite8,
                                        nullWrite16, nullWrite32, nullWrite64, nullWrite128);
    ...
    iopHw_by_page_01 = vtlb_RegisterHandler(iopHwRead8_Page1, iopHwRead16_Page1, iopHwRead32_Page1, _ext_memRead64<2>,
                                            _ext_memRead128<2>, iopHwWrite8_Page1, iopHwWrite16_Page1,
                                            iopHwWrite32_Page1, _ext_memWrite64<2>, _ext_memWrite128<2>);

    iopHw_by_page_03 = vtlb_RegisterHandler(iopHwRead8_Page3, iopHwRead16_Page3, iopHwRead32_Page3, _ext_memRead64<2>,
                                            _ext_memRead128<2>, iopHwWrite8_Page3, iopHwWrite16_Page3,
                                            iopHwWrite32_Page3, _ext_memWrite64<2>, _ext_memWrite128<2>);

    iopHw_by_page_08 = vtlb_RegisterHandler(iopHwRead8_Page8, iopHwRead16_Page8, iopHwRead32_Page8, _ext_memRead64<2>,
                                            _ext_memRead128<2>, iopHwWrite8_Page8, iopHwWrite16_Page8,
                                            iopHwWrite32_Page8, _ext_memWrite64<2>, _ext_memWrite128<2>);
...
#define hwHandlerTmpl(page)                                                                                            \
    hwRead8<page>, hwRead16<page>, hwRead32<page>, hwRead64<page>, hwRead128<page>, hwWrite8<page>, hwWrite16<page>,   \
        hwWrite32<page>, hwWrite64<page>, hwWrite128<page>
    ...
    tlb_fallback_6 = vtlb_RegisterHandler(_ext_memRead8<6>, _ext_memRead16<6>, _ext_memRead32<6>, _ext_memRead64<6>,
                                          _ext_memRead128<6>, _ext_memWrite8<6>, _ext_memWrite16<6>, _ext_memWrite32<6>,
                                          gsWrite64_generic, gsWrite128_generic);

    gs_page_0 = vtlb_RegisterHandler(_ext_memRead8<6>, _ext_memRead16<6>, _ext_memRead32<6>, _ext_memRead64<6>,
                                     _ext_memRead128<6>, _ext_memWrite8<6>, _ext_memWrite16<6>, _ext_memWrite32<6>,
                                     gsWrite64_page_00, gsWrite128_page_00);

    gs_page_1 = vtlb_RegisterHandler(_ext_memRead8<6>, _ext_memRead16<6>, _ext_memRead32<6>, _ext_memRead64<6>,
                                     _ext_memRead128<6>, _ext_memWrite8<6>, _ext_memWrite16<6>, _ext_memWrite32<6>,
                                     gsWrite64_page_01, gsWrite128_page_01);
...
void mmap_MarkCountedRamPage(u32 paddr)
{
    ...
    // eeRecPerfLog.Write((m_PageProtectInfo[rampage].Mode == ProtMode_Manual) ? "Re-protecting page @ 0x%05x"
