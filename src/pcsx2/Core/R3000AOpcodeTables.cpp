...
void psxLWL()
{
    ...
    if (!_Rt_)
        return;
    _rRt_ = (_u32(_rRt_) & (0x00ffffff >> shift)) | (mem << (24 - shift));
...
void psxLWR()
{
    ...
    if (!_Rt_)
        return;
    _rRt_ = (_u32(_rRt_) & (0xffffff00 << (24 - shift))) | (mem >> shift);
...
void psxSB()
{
    iopMemWrite8(_oB_, _u8(_rRt_));
}
void psxSH()
{
    iopMemWrite16(_oB_, _u16(_rRt_));
}
void psxSW()
{
    iopMemWrite32(_oB_, _u32(_rRt_));
}
...
void psxSWL()
{
    ...
    iopMemWrite32((_oB_ & 0xfffffffc), ((_u32(_rRt_) >> (24 - shift))) | (mem & (0xffffff00 << shift)));
    /*
    Mem = 1234.  Reg = abcd
...
void psxSWR()
{
    ...
    iopMemWrite32((_oB_ & 0xfffffffc), ((_u32(_rRt_) << shift) | (mem & (0x00ffffff >> (24 - shift)))));
    /*
    Mem = 1234.  Reg = abcd
...
void (*psxCP2BSC[32])() = {gteMFC2, psxNULL, gteCFC2, psxNULL, gteMTC2, psxNULL, gteCTC2, psxNULL,
                           psxNULL, psxNULL, psxNULL, psxNULL, psxNULL, psxNULL, psxNULL, psxNULL,
                           psxNULL, psxNULL, psxNULL, psxNULL, psxNULL, psxNULL, psxNULL, psxNULL,
                           psxNULL, psxNULL, psxNULL, psxNULL, psxNULL, psxNULL, psxNULL, psxNULL};
